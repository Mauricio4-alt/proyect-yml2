...
import com.mycompany.proyect_yml.domain.*;
...
class ProductoRepositoryTest {
    ...
    void insert(){
        ...
        factura1.getProductos().add(new ProductoEmbebido(producto1.getSerial(),producto1.getNombreProducto(),producto1.getPrecio(), 10));
        factura1.getProductos().add(new ProductoEmbebido(producto2.getSerial(),producto2.getNombreProducto(),producto2.getPrecio(), 50));
        factura1.getProductos().add(new ProductoEmbebido(producto3.getSerial(),producto3.getNombreProducto(),producto3.getPrecio(), 30));
        factura1.getProductos().add(new ProductoEmbebido(producto3.getSerial(),producto3.getNombreProducto(),producto3.getPrecio(), 30));
